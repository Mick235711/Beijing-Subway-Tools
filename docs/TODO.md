...
| 13号线  | 新9版      | 2026-05-28 | ~~东行~~ ~~西行~~   | ~~Chart~~ |
...
- 13号线
  - 西行
    - 龙泽双休日时刻表05:58应为霍营出库车（此后同一错误不再表示）
- 14号线
  - 西南行
    - 园博园双休日时刻表缺06:08
- 15号线
  ...
  - 西行
    ...
    - 崔各庄工作日时刻表05:38应为马泉营出库车（此后同一错误不再表示）
- 16号线
  - 北行
    - 万泉河桥双休日时刻表小时23写成22
- 18号线
...
- 昌平线
  - 进城
    - 朱房北工作日时刻表05:36应为朱辛庄出库车（此后同一错误不再表示）
    - 清河小营桥双休日时刻表05:39应为朱辛庄出库车（此后同一错误不再表示）
- 首都机场线
  - 出城
    - 北新桥星期五时刻表多20:22
    - 东直门星期五时刻表多20:24
